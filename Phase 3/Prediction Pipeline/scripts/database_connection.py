...
data_file = os.path.join(base_path_data, "news_test.csv")
...
# Write the test set dataframe to a SQL table named 'test_data'
df.to_sql("test_data", con=conn, index=False, if_exists="replace")