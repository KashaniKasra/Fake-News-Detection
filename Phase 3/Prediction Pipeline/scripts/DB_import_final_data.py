...
data_file = os.path.join(base_path_data, "final_news_test.csv")
...
# Write the final dataframe to a SQL table named 'final_news_test'
df.to_sql("final_news_test", conn, index=False, if_exists="replace")